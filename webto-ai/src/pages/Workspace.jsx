...
// Dedicated SVG Icon Component to bypass lucide-react export breaking changes
          ...
          <div className="bg-[#0c1322] border border-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl">
            ...
            {pushedRepoUrl ? (
              ...
              <form onSubmit={handlePushToGithub} className="space-y-3 text-xs">
                ...
                >
                  {pushingGithub ? <Loader2 className="w-4 h-4 animate-spin" /> : <GithubIcon className="w-4 h-4" />}
